...
| `docs/engineering/activity-expiration-engine-design.md` | 场景 3 Activity 过期引擎：Redis Sorted Set 时间索引、Spring `@Scheduled`、Redis lock、MySQL 状态迁移。 |
| `docs/engineering/activity-update-design.md` | 最后一个产品 feature：Activity Update / 活动补充说明，边界是 initiator 单向补充而不是聊天/评论/频道。 |
