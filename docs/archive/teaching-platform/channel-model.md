...
当前聊天室已经统一使用高校场景下的 `channelId` 模型。
...
```text
ch-school: 全校大厅，SCHOOL，organizationId = school-1
ch-cs: 计算机学院，DEPARTMENT，organizationId = dept-cs
ch-cs-2401: 计科 2401 班，CLASS，organizationId = class-cs-2401
ch-java: Java 后端开发，COURSE，organizationId = course-java
ch-websocket: 分布式实时通信，COURSE，organizationId = course-websocket
```
